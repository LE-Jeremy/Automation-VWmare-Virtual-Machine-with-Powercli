...
####Creation of our Variables for the connexion to the server###
$Vcenter=Read-Host "Please enter your Vcenter IP address"
$User1=Read-Host "Please enter your Vcenter name"
$Password1=Read-Host "Please enter your Vcenter password"
...
try {
Connect-VIServer -Server $Vcenter -User $User1 -Password $Password1
}
catch {
...
$Sender1=Read-Host "Please enter your mail"
$technician=Read-Host "Please enter the technician's mail"
$Requester=Read-Host "Please enter the requester's mail"
$Supervisor=Read-Host "Please enter the supervisor's mail"
